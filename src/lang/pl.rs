...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Untagged", ""),
        ("new-version-of-{}-tip", ""),
        ("service-certificate-store-error", "Nie można odczytać magazynu certyfikatów komputera. Skontaktuj się z osobą zarządzającą serwerem, aby uzyskać dostęp."),
        ("service-certificate-multiple", "Na tym komputerze znaleziono kilka ważnych certyfikatów dostępu serwisowego. Skontaktuj się z osobą zarządzającą serwerem, aby poprawić konfigurację."),
        ("service-certificate-missing", "Nie można rozpocząć połączenia serwisowego, ponieważ ten komputer nie ma ważnego certyfikatu dostępu. Skontaktuj się z osobą zarządzającą serwerem, aby uzyskać dostęp."),
        ("service-certificate-private-key-error", "Ten komputer ma certyfikat dostępu serwisowego, ale program nie ma uprawnień do użycia jego klucza prywatnego. Skontaktuj się z osobą zarządzającą serwerem, aby uzyskać dostęp."),
    ].iter().cloned().collect();
}
