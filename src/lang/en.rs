...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("service-certificate-store-error", "The computer certificate store could not be read. Contact the server administrator to obtain access."),
        ("service-certificate-multiple", "More than one valid service access certificate was found on this computer. Contact the server administrator to resolve the configuration."),
        ("service-certificate-missing", "A service connection cannot be started because this computer does not have a valid service access certificate. Contact the server administrator to obtain access."),
        ("service-certificate-private-key-error", "This computer has a service access certificate, but the application is not permitted to use its private key. Contact the server administrator to obtain access."),
    ].iter().cloned().collect();
}
